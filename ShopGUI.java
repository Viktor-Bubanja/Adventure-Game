...
public class ShopGUI {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 724, 462);
		...
		frame.getContentPane().add(moneyLeftLabel);
		...
		frame.getContentPane().add(buySmallPotionButton);
		...
		frame.getContentPane().add(buyQuickPotionButton);
		...
		frame.getContentPane().add(buyBigPotionButton);
		...
		frame.getContentPane().add(buyMapButton);
